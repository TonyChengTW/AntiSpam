...
<table>
<form action='spam_login_new.pl' method='post'>
<tr>
...
print '                  <td width="90" align="left" bgcolor="#E1F0FF"><font size="-1">　</font></td>'.$n;
print '                </tr>'.$n;
print '<form name="form1" method="post" action="spam_send_new.pl" onSubmit="return Check(form1)"  ENCTYPE="multipart/form-data">'.$n;
...
print '                <tr> '.$n;
print '                  <td align="left" width="150" bgcolor="#E1F0FF"><font size="-1">檢舉信件'.$n;
print '                    </font></td>'.$n;
...
print '                <tr> '.$n;
print '                  <td align="left" width="100%" colspan=3><input type="file" name="FILE1"></td>'.$n;
print '                </tr>'.$n;
