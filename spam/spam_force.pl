...
print '查詢時段:<input type="text" name="chk_datetime" value="2005-10-10 10:10:10">'.$n;
#print '<br>種類:<input type="text" name="service" value="'.$service.'">'.$n;
print '<br>種類:<select size=1 name=service><option value=adsl selected>adsl</option><option value=d>56k</option><option value=cm>cable</option></select>'.$n;

print '登出時間:<input type="text" name="logout" value="2005-10-10 10:10:10">'.$n;
print '<br>上線使用時間:<input type="text" name="used" value="100">'.$n;
