...
print '                    </font></td>'.$n;
print '                </tr>'.$n;
print '<form name="form1" method="post" action="test_spam_checkip.pl" onSubmit="return Check(form1)">'.$n;
print '                <tr> '.$n;
...
print '                </tr>'.$n;
print '</form>'.$n;
print '<form name="form1" method="post" action="spam_showcust.pl" onSubmit="return Check(form1)">'.$n;
print '                <tr> '.$n;
